...
# from trans_model import EncoderDecoder
...
def main(args):
    ...
    # Load vocabulary JSON、pkl
    try:
        voc = json.load(open(args['vocab_path'], 'rb'))
        # voc = pickle.load(open(args['vocab_path'], 'rb'))
    except:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model_path', type=str, default='src/model/CaptionModel_24.pth.tar', help='path for trained model')
